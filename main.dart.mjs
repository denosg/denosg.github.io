...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1651: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1662: x0 => new Array(x0),
      _1664: x0 => x0.length,
      _1666: (x0,x1) => x0[x1],
      _1667: (x0,x1,x2) => x0[x1] = x2,
      _1670: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1672: x0 => new Int8Array(x0),
      _1673: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1674: x0 => new Uint8Array(x0),
      _1682: x0 => new Int32Array(x0),
      _1684: x0 => new Uint32Array(x0),
      _1686: x0 => new Float32Array(x0),
      _1688: x0 => new Float64Array(x0),
      ...
      _1720: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1721: () => new TextDecoder("utf-8", {fatal: true}),
      _1722: () => new TextDecoder("utf-8", {fatal: false}),
      _1723: x0 => new WeakRef(x0),
      _1724: x0 => x0.deref(),
      _1730: Date.now,
      _1732: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1733: s => {
      ...
      _1735: () => typeof dartUseDateNowForTicks !== "undefined",
      _1736: () => 1000 * performance.now(),
      _1737: () => Date.now(),
      _1738: () => {
      ...
      _1740: () => new WeakMap(),
      _1741: (map, o) => map.get(o),
      _1742: (map, o, v) => map.set(o, v),
      _1743: () => globalThis.WeakRef,
      _1754: s => JSON.stringify(s),
      _1755: s => printToConsole(s),
      _1756: a => a.join(''),
      _1757: (o, a, b) => o.replace(a, b),
      _1759: (s, t) => s.split(t),
      ...
      _1763: s => s.trimLeft(),
      _1764: s => s.trimRight(),
      _1766: (s, p, i) => s.indexOf(p, i),
      _1767: (s, p, i) => s.lastIndexOf(p, i),
      _1768: (s) => s.replace(/\$/g, "$$$$"),
      _1769: Object.is,
      ...
      _1800: (t, s) => t.set(s),
      _1801: l => new DataView(new ArrayBuffer(l)),
      _1802: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1804: o => o.buffer,
      _1805: o => o.byteOffset,
      _1806: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1807: (b, o) => new DataView(b, o),
      _1808: (b, o, l) => new DataView(b, o, l),
      _1809: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1810: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1811: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1812: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1813: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1814: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1815: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1816: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1817: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1818: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1819: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1820: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1823: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1824: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1825: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1826: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1827: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1828: Function.prototype.call.bind(DataView.prototype.setFloat64),
      ...
      _1893: (x0,x1) => x0.test(x1),
      _1894: (x0,x1) => x0.exec(x1),
      _1895: (x0,x1) => x0.exec(x1),
      _1896: x0 => x0.pop(),
      _1898: o => o === undefined,
      _1917: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1919: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1920: o => o instanceof RegExp,
      _1921: (l, r) => l === r,
      _1922: o => o,
      _1923: o => o,
      _1924: o => o,
      ...
      _1926: o => o.length,
      _1929: (o, i) => o[i],
      _1930: f => f.dartFunction,
      _1931: l => arrayFromDartList(Int8Array, l),
      _1932: l => arrayFromDartList(Uint8Array, l),
      _1933: l => arrayFromDartList(Uint8ClampedArray, l),
      _1934: l => arrayFromDartList(Int16Array, l),
      _1935: l => arrayFromDartList(Uint16Array, l),
      _1936: l => arrayFromDartList(Int32Array, l),
      _1937: l => arrayFromDartList(Uint32Array, l),
      _1938: l => arrayFromDartList(Float32Array, l),
      _1939: l => arrayFromDartList(Float64Array, l),
      _1940: x0 => new ArrayBuffer(x0),
      _1941: (data, length) => {
      ...
      _1942: l => arrayFromDartList(Array, l),
      _1943: () => ({}),
      _1944: () => [],
      _1945: l => new Array(l),
      _1946: () => globalThis,
      ...
      _1974: x0 => x0.flags,
      _1975: x0 => x0.multiline,
      _1976: x0 => x0.ignoreCase,
      _1977: x0 => x0.unicode,
      _1978: x0 => x0.dotAll,
      _1979: (x0,x1) => x0.lastIndex = x1,
      _1981: (o, p) => o[p],
      _1984: x0 => x0.random(),
      _1985: x0 => x0.random(),
      _1986: (x0,x1) => x0.getRandomValues(x1),
      _1987: () => globalThis.crypto,
      _1989: () => globalThis.Math,
      _1991: Function.prototype.call.bind(Number.prototype.toString),
      _1992: (d, digits) => d.toFixed(digits),
      _3922: () => globalThis.window,
      _3986: x0 => x0.navigator,
      _4377: x0 => x0.userAgent,
      _6623: x0 => x0.signal,
      _8527: x0 => x0.value,
      _8529: x0 => x0.done,
      _9252: x0 => x0.url,
      _9254: x0 => x0.status,
      _9256: x0 => x0.statusText,
      _9257: x0 => x0.headers,
      _9258: x0 => x0.body,
